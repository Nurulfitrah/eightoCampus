                           ...
                           <div class="form-group"> 
                               <div class="col-sm-5">
                                   <select class="form-control" name="userType" size="1">
                                                ...
                                                <option value="3">Bio-Information</option>
                                            </select>
                               </div><br/>
                               <div class="col-sm-5">
                                   <input style="width: 25%; height: 25px" type="text" name="txtSearch" class="form-control" placeholder="Search Subjects by Name / Code" />
                               </div><br/>
                           <div class="col-sm-2">
                               <input style="width: 15%; height: 25px" type="submit" Class="btn btn-info" value="View List" />
                               </div><br/>
                           </div>
                          ...
                          <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Offered</td>
                                    <td>2</td>
                                    <td><a href="ad_manage_subject_edit.jsp">Edit</a></td>
                                </tr>
                                <tr>
                                    <td>1</td>
