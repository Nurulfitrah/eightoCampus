                          ...
                          <tbody>
                           ...
                           <div class="form-group"> 
                               ...
                               <div class="col-sm-11">
                                 ...
                                 <div class="col-sm-8">
                                     <input style="width: 25%; height: 25px" type="text" class="form-control" name="txtName" value="" placeholder="Muhammad" />
                             </div>  </div><br/>
                                        <div class="form-group">
                                 <label class="col-sm-3 control-label">Department : </label>
                                 <div class="col-sm-8">
                                     <input style="width: 25%; height: 25px" type="text" class="form-control" name="txtDept" value="" placeholder="010-123456" />
                             </div>  </div><br/>
                                  <div class="form-group">
                                 <label class="col-sm-3 control-label">Date of Birth : </label>
                                 <div class="col-sm-8">
                                     <input style="width: 25%; height: 25px" type="date" class="form-control" name="txtDOB" value="" placeholder="Muhammad" />
                             </div>  </div><br/>
                                       <div class="form-group">
                                 <label class="col-sm-3 control-label">IC No : </label>
                                 <div class="col-sm-8">
                                     <input style="width: 25%; height: 25px" type="text" class="form-control" name="txtIC" value="" placeholder="940825126361" />
                             </div>  </div><br/>
                                        <div class="form-group">
                                 <label class="col-sm-3 control-label">Email : </label>
                                 <div class="col-sm-8">
                                     <input style="width: 25%; height: 25px" type="text" class="form-control" name="txtEmail" value="" placeholder="Muhammad@gmail.com" />
                             </div>  </div><br/>
                                        <div class="form-group">
                                 <label class="col-sm-3 control-label">Gender : </label>
                                 <div class="col-sm-8">
                                     <input style="width: 25%; height: 25px" type="text" class="form-control" name="txtGender" value="" placeholder="Lelaki" />
                             </div>  </div><br/>
                                       <div class="form-group">
                                 <label class="col-sm-3 control-label">Mobile : </label>
                                 <div class="col-sm-8">
                                     <input style="width: 25%; height: 25px" type="text" class="form-control" name="txtMobile" value="" placeholder="010-123456" />
                             </div>  </div><br/>
                                 <div class="form-group">
                                 <label class="col-sm-3 control-label">Address : </label>
                                 <div class="col-sm-8">
                                     <input style="width: 25%; height: 25px" type="text" class="form-control" name="txtAdd" value="" placeholder="SAndakan Sabah" />
                             </div>  </div><br/>       
                               </div>
                                ...
                                <div class="col-md-offset-3 col-md-9 right">
                                    <input style="width: 15%; height: 25px" type="submit" name="btnDaftar" Class="btn btn-info" value="Edit" />
                                    </div></td>
                              </tr>
                          </tbody>
                      </table>
